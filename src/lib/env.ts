...
export function validateEnv(): void {
  ...
  if (process.env.NODE_ENV === 'production' && process.env.REQUIRE_DISTRIBUTED_RATE_LIMITS !== 'true') {
    throw new Error('REQUIRE_DISTRIBUTED_RATE_LIMITS must be true in production.');
  }
