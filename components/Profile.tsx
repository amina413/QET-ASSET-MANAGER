      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-1">
          <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6 text-center">
             ...
             <span className="inline-block mt-2 px-3 py-1 bg-ptdf-50 text-ptdf-700 text-xs font-bold rounded-full border border-ptdf-100">
                {currentUser.role}
             </span>
        ...
        <div className="md:col-span-2">
           <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6 h-full">
              <h3 className="text-lg font-bold text-slate-800 mb-4 flex items-center">
                 <Clock size={20} className="mr-2 text-ptdf-600" /> Recent Activity
              </h3>
                 ...
                 {myActivity.length > 0 ? (
                    myActivity.map(activity => (
                       <div key={activity.id} className="relative pl-6 border-l-2 border-slate-100 pb-2 last:pb-0">
                          <div className="absolute -left-[5px] top-1 w-2.5 h-2.5 rounded-full bg-ptdf-400 border-2 border-white"></div>
