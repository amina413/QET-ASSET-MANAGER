        ...
        <div className="w-full md:w-64 bg-slate-50 p-4 border-r border-slate-100">
           <div className="space-y-1">
              <button 
                ...
                className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors ${activeTab === 'general' ? 'bg-white text-ptdf-600 shadow-sm border border-slate-200' : 'text-slate-600 hover:bg-slate-100'}`}
              >
                <Monitor size={18} />
                <span>General</span>
              </button>
              <button 
                ...
                className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors ${activeTab === 'security' ? 'bg-white text-ptdf-600 shadow-sm border border-slate-200' : 'text-slate-600 hover:bg-slate-100'}`}
              >
                <Lock size={18} />
                <span>Security</span>
              </button>
              <button 
                ...
                className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors ${activeTab === 'notifications' ? 'bg-white text-ptdf-600 shadow-sm border border-slate-200' : 'text-slate-600 hover:bg-slate-100'}`}
              >
                <Bell size={18} />
        ...
        <div className="flex-1 p-8">
                 ...
                 <div className="grid grid-cols-1 gap-6">
                    <div>
                       ...
                       <div className="flex gap-4">
                          <div className="border-2 border-ptdf-500 rounded-lg p-3 bg-white cursor-pointer w-32 shadow-sm">
                             <div className="h-12 bg-slate-100 rounded mb-2"></div>
                             <p className="text-center text-xs font-bold text-ptdf-700">Light Mode</p>
                          </div>
           ...
           {activeTab === 'security' && (
              <div className="space-y-6 animate-fadeIn">
                 ...
                 <div className="pt-4">
                    <button className="text-ptdf-600 text-sm font-medium hover:underline">Enable Two-Factor Authentication</button>
                 </div>
              </div>
           )}
              ...
              <div className="space-y-6 animate-fadeIn">
                 ...
                 <div className="space-y-4">
                    <label className="flex items-center justify-between p-3 border border-slate-100 rounded-lg hover:bg-slate-50 cursor-pointer">
                       ...
                       <div className={`w-10 h-5 rounded-full relative transition-colors ${notifications.email ? 'bg-ptdf-600' : 'bg-slate-300'}`} onClick={() => setNotifications({...notifications, email: !notifications.email})}>
                    ...
                    <label className="flex items-center justify-between p-3 border border-slate-100 rounded-lg hover:bg-slate-50 cursor-pointer">
                       ...
                       <div className={`w-10 h-5 rounded-full relative transition-colors ${notifications.push ? 'bg-ptdf-600' : 'bg-slate-300'}`} onClick={() => setNotifications({...notifications, push: !notifications.push})}>
                    ...
                    <label className="flex items-center justify-between p-3 border border-slate-100 rounded-lg hover:bg-slate-50 cursor-pointer">
                       ...
                       <div className={`w-10 h-5 rounded-full relative transition-colors ${notifications.weeklyReport ? 'bg-ptdf-600' : 'bg-slate-300'}`} onClick={() => setNotifications({...notifications, weeklyReport: !notifications.weeklyReport})}>
           ...
           <div className="mt-8 pt-6 border-t border-slate-100 flex justify-end">
              <button 
                onClick={handleSave}
                className="px-6 py-2 bg-ptdf-600 text-white rounded-lg font-bold hover:bg-ptdf-700 transition-colors flex items-center"
              >
