...
const AssetLookup: React.FC<AssetLookupProps> = ({ initialSearchTerm = '' }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto pb-24">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 mb-6 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <button 
            onClick={startCamera}
            className="flex flex-col items-center justify-center p-4 bg-ptdf-50 border border-ptdf-200 rounded-xl text-ptdf-700 hover:bg-ptdf-100 transition-colors"
          >
          ...
          <button 
            ...
            className="flex flex-col items-center justify-center p-4 bg-accent-50 border border-accent-200 rounded-xl text-accent-700 hover:bg-accent-100 transition-colors"
          >
        ...
        <div className="space-y-4 animate-slideIn">
          ...
          {isCalculatorOpen ? (
            ...
            <>
              ...
              {activeTab === 'history' && (
                <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 animate-fadeIn">
                  <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-4">Asset Timeline</h3>
                  <div className="relative border-l-2 border-slate-200 ml-3 space-y-8 pl-6 py-2">
                    {/* Mock History Items */}
                    <div className="relative">
                      <div className="absolute -left-[31px] bg-green-500 h-4 w-4 rounded-full border-2 border-white shadow-sm"></div>
                      <p className="text-sm font-bold text-slate-800">Asset Verification</p>
                      <p className="text-xs text-slate-500 mt-1">Verified by Audit Team (Chioma Obi)</p>
                      <span className="text-xs text-slate-400 mt-1 flex items-center">2 days ago</span>
                    </div>
                    <div className="relative">
                      <div className="absolute -left-[31px] bg-ptdf-500 h-4 w-4 rounded-full border-2 border-white shadow-sm"></div>
                      <p className="text-sm font-bold text-slate-800">Custodian Changed</p>
                      <p className="text-xs text-slate-500 mt-1">Transferred from IT Store to Emeka Okafor</p>
                      <span className="text-xs text-slate-400 mt-1 flex items-center">Jan 20, 2023</span>
                    </div>
                    <div className="relative">
                      <div className="absolute -left-[31px] bg-slate-300 h-4 w-4 rounded-full border-2 border-white shadow-sm"></div>
                      <p className="text-sm font-bold text-slate-800">Asset Registered</p>
                      <p className="text-xs text-slate-500 mt-1">System Entry by Procurement</p>
                      <span className="text-xs text-slate-400 mt-1 flex items-center">Jan 15, 2023</span>
                    </div>
                  </div>
                </div>
              )}
      ...
      {!activeAsset && !isCameraOpen && !isAnalyzing && searchResults.length === 0 && (
        <div className="text-center py-16 text-slate-400">
          ...
          <p className="text-lg font-medium text-slate-500">Ready to Search</p>
          <p className="text-sm">Scan a barcode, upload a photo, or search by text.</p>
        </div>
      )}
    </div>
  );
